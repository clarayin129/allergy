...
export default function RestaurantCard({ restaurant }: RestaurantCardProps) {
  ...
  function handleClick() {
    saveRestaurantMeta({ place_id: restaurant.place_id, name: restaurant.name, address: restaurant.address, cuisine: restaurant.cuisine });
  }
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-4 flex items-start gap-4 hover:shadow-md transition-shadow active:scale-[0.99]">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-start justify-between gap-2">
            ...
            <SafetyBadge risk={restaurant.cached_risk} size="sm" />
          </div>
